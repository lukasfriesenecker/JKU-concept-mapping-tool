...
function KeyboardWrapper({ connection, viewport, onChange, onEnter, from, to }: IProps) {
  ...
  return (
    ...
    >
      <Keyboard
        ...
        onChange={(value) => onChange(connection.id, value, "connection")} onKeyPress={onKeyPress}
